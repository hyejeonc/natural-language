...
# https://colab.research.google.com/drive/1DEgvePzUQEmFkOco9GHpJl8hWxtPXFVQ?usp=drive_open

# 트랜스포머 패키지는 여러 언어를 위한 CLIP 을 위한 라이브러리.. 
# 토크나이저는 


m2_Embeddings.ipynb
m2_Embeddings.ipynb_
...
import torch.nn.functional as F        # Contains functional API 
...
tensor([[49406,   320, 18471, 49407],
        ...
        # 마지막 패딩은 왜 넣어주느냐? 빈칸 더미처럼 넣어줘서 총 토큰들의 길이들을 다 같게 맞춰준다
...
The cosine of the angle θ between the arrows is
cosine_sim(a,b)=cos(θ)=a⋅b∥a∥∥b∥
